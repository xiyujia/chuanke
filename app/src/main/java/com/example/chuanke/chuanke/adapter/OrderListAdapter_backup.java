...
public class OrderListAdapter_backup extends BaseAdapter {
    ...
    public OrderListAdapter_backup(Activity activity, List<OrderBean> orderList) {
...
//            holder.tv_order_price = view.findViewById(R.id.tv_order_price);
            ...
            holder = (OrderListAdapter_backup.OrderList) view.getTag();
        }
...
//        imageLoader.DisplayImage(picUrl, activity, holder.imgOffer);
        ...
        holder.imgOffer.setTag(i);
        holder.imgOffer.setBackgroundResource(R.drawable.ic_default);
